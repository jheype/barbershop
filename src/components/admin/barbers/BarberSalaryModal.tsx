...
export default function BarberSalaryModal({
  open,
  barberId,
  onClose,
  onSaved,
  ...
  const title = useMemo(() => "Registrar salário", []);
          ...
          >
            <div className="flex items-center justify-between border-b border-[#24272D] px-5 py-4">
              <div className="min-w-0">
                ...
                <p className="mt-0.5 text-xs text-[#AEB4BE] break-words">Lance o pagamento do salário.</p>
              </div>
